...
NODE="${NODE_BIN:-}"
if [ -z "$NODE" ] && [ -x "/Users/kengxiaomai/.workbuddy/binaries/node/versions/22.12.0/bin/node" ]; then
  NODE="/Users/kengxiaomai/.workbuddy/binaries/node/versions/22.12.0/bin/node"
fi
if [ -z "$NODE" ]; then
...
NODE_MODULES="/Users/kengxiaomai/.workbuddy/binaries/node/workspace/node_modules"
